...
def main():
    ...
    copy_number = [args.copy_number]*len(args.genome_sequence) if isinstance(args.copy_number, int) else args.copy_number
    target_dict, genome = get_sequence(args.target_sequence, args.genome_sequence, copy_number)
